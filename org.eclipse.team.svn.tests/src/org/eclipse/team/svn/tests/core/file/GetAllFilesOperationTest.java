...
/**
 * Get all files operation test
 * 
 * @author Elena Matokhina
 */
public class GetAllFilesOperationTest extends AbstractOperationTestCase {

	protected IActionOperation getOperation() {
		return new GetAllFilesOperation(this.getFirstFolder());
	}
