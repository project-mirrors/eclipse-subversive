...
public abstract class CheckoutOperationTest extends AbstractOperationTestCase {
	protected IActionOperation getOperation() {
	    ...
	    CheckoutAsOperation mainOp = new CheckoutAsOperation(this.getFirstProject().getName(), trunk.asRepositoryContainer(this.getFirstProject().getName(), false), true);
	    CompositeOperation op = new CompositeOperation(mainOp.getId());
	    op.add(mainOp);
	    op.add(new CheckoutAsOperation(this.getSecondProject().getName(), trunk.asRepositoryContainer(this.getSecondProject().getName(), false), true));
		return op;
	}
