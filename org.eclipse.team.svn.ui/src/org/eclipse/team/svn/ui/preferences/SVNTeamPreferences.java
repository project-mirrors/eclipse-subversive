 ...
 *    Dann Martens - Text decorations 'ascendant' variable
 *******************************************************************************/
...
public final class SVNTeamPreferences {
	...
	public static final boolean MERGE_USE_JAVAHL_DEFAULT = true;
...
//	{outgoing_flag} {name} {revision} [{location_label}{root_prefix}: {fullname}]
	...
	public static void setDefaultRepositoryValues(IPreferenceStore store) {
		...
		store.setDefault(SVNTeamPreferences.fullRepositoryName(SVNTeamPreferences.REPOSITORY_TAGS_DEFAULT), SVNTeamPreferences.REPOSITORY_TAGS_DEFAULT);
