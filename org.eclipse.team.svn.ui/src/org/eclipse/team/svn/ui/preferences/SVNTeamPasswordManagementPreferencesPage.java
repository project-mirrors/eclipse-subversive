 ...
 */
public class SVNTeamPasswordManagementPreferencesPage extends PreferencePage implements IWorkbenchPreferencePage, ISelectionChangedListener {
	...
	protected Control createContents(Composite parent) {
		...
		this.removeAllButton.addListener(SWT.Selection, new Listener() {
			public void handleEvent(Event e) {
				removeAll();
			}
		});
