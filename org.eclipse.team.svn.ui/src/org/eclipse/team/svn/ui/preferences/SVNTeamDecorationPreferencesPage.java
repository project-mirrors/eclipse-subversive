 ...
 *    Dann Martens - Text decorations 'ascendant' variable, More decoration options
 *******************************************************************************/
 ...
 */
public class SVNTeamDecorationPreferencesPage extends PreferencePage implements IWorkbenchPreferencePage {
	...
	protected class DemoVariableContentProvider implements IVariableContentProvider {
		...
		public String getValue(IVariable var) {
			if (var.equals(TextVariableSetProvider.VAR_ADDED_FLAG)) {
				...
				String format = SVNTeamUIPlugin.instance().getResource("PreferencePage.timeFormat");
