 ...
 */
public class SVNTeamPreferencesPage extends PreferencePage implements IWorkbenchPreferencePage {
	...
	protected Control createViewSettingsPage(Composite parent) {
		...
		this.enablePagingButton.setText(SVNTeamUIPlugin.instance().getResource("MainPreferencePage.historyEnablePaging"));
		...
		this.pageSizeField.addModifyListener(new ModifyListener() {
			public void modifyText(ModifyEvent e) {
				try {
					int tempPageSize = Integer.parseInt(SVNTeamPreferencesPage.this.pageSizeField.getText());
					SVNTeamPreferencesPage.this.pageSize = tempPageSize;
				}
				catch (Exception ex) {
					SVNTeamPreferencesPage.this.pageSizeField.setText(String.valueOf(SVNTeamPreferencesPage.this.pageSize));
				}
	...
	protected Control createRepositorySettingsPage(Composite parent) {
		...
		data = new GridData();
		label.setLayoutData(data);
		label.setText(SVNTeamUIPlugin.instance().getResource("MainPreferencePage.repositoryHeadName"));
		...
		label = new Label(group, SWT.NULL);
		label.setLayoutData(new GridData());
		label.setText(SVNTeamUIPlugin.instance().getResource("MainPreferencePage.repositoryBranchesName"));
		...
		label = new Label(group, SWT.NULL);
		label.setLayoutData(new GridData());
		label.setText(SVNTeamUIPlugin.instance().getResource("MainPreferencePage.repositoryTagsName"));
