...
public class UIOptionProvider implements IOptionProvider {
	...
	public String getDefaultBranchesName() {
		return SVNTeamPreferences.getRepositoryString(SVNTeamUIPlugin.instance().getPreferenceStore(), SVNTeamPreferences.REPOSITORY_BRANCHES_NAME);
	}
	
	public String getDefaultTagsName() {
		return SVNTeamPreferences.getRepositoryString(SVNTeamUIPlugin.instance().getPreferenceStore(), SVNTeamPreferences.REPOSITORY_TAGS_NAME);
	}
	
	public String getDefaultTrunkName() {
		return SVNTeamPreferences.getRepositoryString(SVNTeamUIPlugin.instance().getPreferenceStore(), SVNTeamPreferences.REPOSITORY_HEAD_NAME);
	}
	...
	public PropertyData[] getAutomaticProperties(String template) {
		...
		Object[] autoProperties = SVNTeamAutoPropsPreferencePage.loadProperties(store);
