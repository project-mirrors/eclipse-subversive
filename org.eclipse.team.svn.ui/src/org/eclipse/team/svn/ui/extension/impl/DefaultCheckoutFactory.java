...
public class DefaultCheckoutFactory implements ICheckoutFactory {
	...
	public IActionOperation getCheckoutOperation(Shell shell, IRepositoryResource []remote, HashMap checkoutMap, boolean respectHierarchy, String location, boolean checkoutRecursively) {
		return CheckoutAction.getCheckoutOperation(shell, remote, checkoutMap, respectHierarchy, location, checkoutRecursively);
	}
