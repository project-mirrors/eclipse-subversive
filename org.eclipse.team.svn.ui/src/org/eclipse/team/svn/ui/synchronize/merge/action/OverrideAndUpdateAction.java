 ...
 *    Tobias Bosch - bug fix: Quick fix for JavaSVN problem with "force" option
 *******************************************************************************/
...
public class OverrideAndUpdateAction extends AbstractSynchronizeModelAction {
	...
	protected IActionOperation execute(final FilteredSynchronizeModelOperation operation) {
        ...
        final IRepositoryResource fromProject = MergeSubscriber.instance().getMergeStatusOperation().getFrom()[0];
