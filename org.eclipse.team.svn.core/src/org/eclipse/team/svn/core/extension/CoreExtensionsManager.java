...
public class CoreExtensionsManager {
	...
	public ISVNClientWrapperFactory getSVNClientWrapperFactory(String id) {
		ISVNClientWrapperFactory retVal = (ISVNClientWrapperFactory)this.clients.get(id);
		return retVal == null ? (ISVNClientWrapperFactory)this.clients.get(ISVNClientWrapperFactory.DEFAULT_ID) : retVal;
	}
	...
	private CoreExtensionsManager() {
		...
		for (int i = 0; i < extensions.length; i++) {
			ISVNClientWrapperFactory factory = (ISVNClientWrapperFactory)extensions[i];
			try {
