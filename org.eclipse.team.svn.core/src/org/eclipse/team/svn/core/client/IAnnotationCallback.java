...
public interface IAnnotationCallback {
	/**
	 * This method will be called by the client library for every line in a file.
	 * 
	 * @param line
	 ...
	 */
	public void nextLine(String line, long revision, long date, String author, long mergedWithRevision, long mergedWithDate, String mergedWithAuthor, String mergedWithPath);
}
