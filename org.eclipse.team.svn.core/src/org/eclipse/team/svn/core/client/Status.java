...
public class Status {
	...
	/**
	 * The entry local content status in compare to base revision (see {@link Status.Kind})
	 */
	public final int textStatus;

	/**
	 * The entry local properties status in compare to base revision (see {@link Status.Kind})
	 */
	...
	/**
	 * The entry remote content status in compare to base revision (see {@link Status.Kind})
	 */
	public final int repositoryTextStatus;

	/**
	 * The entry remote properties status in compare to base revision (see {@link Status.Kind})
	 */
	...
	public Status(String path, String url, int nodeKind, long revision, long lastChangedRevision, long lastChangedDate, String lastCommitAuthor, int textStatus, int propStatus,
			...
			String urlCopiedFrom, long revisionCopiedFrom, boolean switched, String lockToken, String lockOwner, String lockComment, long lockCreationDate, Lock reposLock,
