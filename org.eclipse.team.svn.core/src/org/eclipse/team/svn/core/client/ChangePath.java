...
public class ChangePath {
	...
	/**
	 * The {@link ChangePath} instance could be initialized only once because all fields are final
	 * 
	 * @param path
	 *            the path of the changed entry
	 * @param action
	 ...
	 */
	public ChangePath(String path, char action, String copiedFromPath, long copiedFromRevision) {
		this.path = path;
