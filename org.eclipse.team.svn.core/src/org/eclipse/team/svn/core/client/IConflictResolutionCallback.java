 ...
 */
public interface IConflictResolutionCallback {
	/**
	 * Acquires conflict resolution method.
	 * 
	 * @param descriptor
	 *            a conflict description
	 * @return The conflict resolution method (see {@link ConflictResolution})
	 * @throws ClientWrapperException
	 *             If an error occurs.
	 */
	public ConflictResolution resolve(ConflictDescriptor descriptor) throws ClientWrapperException;
