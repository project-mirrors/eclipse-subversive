...
public class ConflictResolution {
	...
	/**
	 * The {@link ConflictResolution} instance could be initialized only once because all fields are final
	 * 
	 * @param choice
	 *            the acceptable choice
	 * @param mergedPath
	 ...
	 */
	public ConflictResolution(int choice, String mergedPath) {
		this.choice = choice;
