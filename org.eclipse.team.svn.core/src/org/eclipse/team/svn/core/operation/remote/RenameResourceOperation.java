...
public class RenameResourceOperation extends AbstractRepositoryOperation implements IRevisionProvider {
	...
	protected void runImpl(IProgressMonitor monitor) throws Exception {
		...
		try {
			...
			proxy.move(SVNUtility.encodeURL(resource.getUrl()), SVNUtility.encodeURL(newUrl), this.message, resource.getSelectedRevision() /*NOTE unused ???*/, false, new SVNProgressMonitor(this, monitor, null));
		}
		finally {
