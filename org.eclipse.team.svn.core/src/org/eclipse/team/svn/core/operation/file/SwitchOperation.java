...
public class SwitchOperation extends AbstractFileOperation {
	...
	protected void runImpl(IProgressMonitor monitor) throws Exception {
		...
		try {
			proxy.doSwitch(file.getAbsolutePath(), SVNUtility.encodeURL(this.destination.getUrl()), this.destination.getSelectedRevision(), this.destination.getPegRevision(), Depth.unknownOrFiles(true), false, false, new SVNProgressMonitor(this, monitor, null));
		}
		finally {
