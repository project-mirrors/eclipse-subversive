			...
			for (int i = 0; i < resources.length && !monitor.isCanceled(); i++) {
				...
				this.protectStep(new IUnprotectedOperation() {
					public void run(IProgressMonitor monitor) throws Exception {
						...
						proxy.copy(SVNUtility.encodeURL(current.getUrl()), url2, BranchTagOperation.this.message, current.getSelectedRevision(), new SVNProgressMonitor(BranchTagOperation.this, monitor, null));
					}
