...
public class ImportOperation extends AbstractRepositoryOperation implements IRevisionProvider {
	...
	protected void runImpl(IProgressMonitor monitor) throws Exception {
		...
		try {
			...
			proxy.doImport(this.path, SVNUtility.encodeURL(resource.getUrl()), this.message, Depth.infinityOrFiles(this.isRecursive), true, true, new SVNProgressMonitor(this, monitor, null));
		}
		finally {
