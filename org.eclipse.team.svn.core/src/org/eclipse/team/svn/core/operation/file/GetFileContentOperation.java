	...
	protected void runImpl(IProgressMonitor monitor) throws Exception {
		...
		try {
			...
			if (kind == Kind.BASE || kind == Kind.WORKING) {
				proxy.streamFileContent(new EntryRevisionReference(file.getAbsolutePath(), null, this.revision), this.bufferSize, this.target, new SVNProgressMonitor(this, monitor, null));
			}
			else {
